...
public class GithubController {
    ...
    public JSONObject issues(){
        //return GsonUtils.toJSON(GITHUB_ISSUE_RESULT);
        return JSONObject.parseObject(GITHUB_ISSUE_RESULT);
    }


    private static final String GITHUB_ISSUE_RESULT = """
            {
                "data": [
                    {
                        "id": 624748504,
